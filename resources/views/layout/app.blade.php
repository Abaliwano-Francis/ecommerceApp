									...
									<div class="wrap-contact-detail">
										<ul>
											...
											<li>
												...
												<p class="contact-txt">Contact@gmain.com</p>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+256) 773 319669 - (+256) 700 220554</b>
									</div>
								</div>
							</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © @php echo date("Y") @endphp Francis E-Commerce Platform. All rights reserved</p>
					</div>
